...
contract PioneerPay is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pioneer Pay", "PPAY") {
        ...
        transferMarketingFee = 2;
        transferLiquidityFee = 0;
        transferTotalFees = transferMarketingFee + transferLiquidityFee;

        marketingWallet = address(0xc356BE6453428aA0dAd81874B2f988041F40fB5b); // set as marketing wallet
